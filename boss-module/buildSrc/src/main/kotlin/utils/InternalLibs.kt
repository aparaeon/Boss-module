...
object InternalLibs {
    ...
    val analytics:        InternalLib = InternalLib(base = "gg.mmorealms:analytics-module",         version = "1.0.51")
    val economy:          InternalLib = InternalLib(base = "gg.mmorealms:economy-module",           version = "1.0.55")
    ...
    val chat:             InternalLib = InternalLib(base = "gg.mmorealms:chat-module",              version = "1.0.69")
    ...
    val essentials:       InternalLib = InternalLib(base = "gg.mmorealms:essentials-module",        version = "1.0.101")
