...
@Entity(name = "warns")
@NoArgsConstructor
public class UserWarn extends GenericUserPunishment {

	public UserWarn(UUID user, UUID issuedBy, String reason, Time duration) {
	...
	protected MessageBuilder getUserMessageTemplate() {
		return ModerationVelocityModule.instance().getConfig().lang.warnMessage;
	}

	@Override
	@Transient
	protected MessageBuilder getShortEntry() {
		return ModerationVelocityModule.instance().getConfig().lang.warnEntry;
	}
