package gg.mmorealms.module.core.common.dto.privatebin.models;

import gg.mmorealms.module.core.common.dto.privatebin.enums.Compression;
import gg.mmorealms.module.core.common.dto.privatebin.enums.Expire;
import gg.mmorealms.module.core.common.dto.privatebin.enums.PasteFormat;
import gg.mmorealms.module.core.common.dto.privatebin.utils.Base58;
...
//            e.printStackTrace();
		...
		if (responseString.length() > 0) {
			...
			if (receivedID == null)
				throw new RuntimeException("Failed to get paste ID from response: " + responseString);
