...
import gg.mmorealms.module.core.backend.fabric.CoreFabricModule;
import net.minecraft.network.chat.Component;
import net.minecraft.network.protocol.game.ClientboundOpenScreenPacket;
import net.minecraft.world.item.ItemStack;

public class FabricGUI extends SimpleGui {
	...
	public Component getTitle() {
		return CoreFabricModule.instance().getMiniMessageManager().parse(gui.getTitle());
	}
			...
			setSlot(slot, new GuiElementInterface() {
				...
				public ClickCallback getGuiCallback() {
					return (ItemClickCallback) (index, clickType, minecraftClickType) -> {
						GUIButton button = gui.getButtons()[finalSlot];
