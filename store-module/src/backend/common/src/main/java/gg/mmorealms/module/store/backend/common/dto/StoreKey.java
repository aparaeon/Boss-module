...
@Getter
public class StoreKey extends StoreEntry {

	public StoreKey(String id, String name, String image, Price price, MessageBuilderList commands) {
	...
	public void bake() {
		this.guiButton = GUIButton.empty()
				...
				.lore(StoreBackendModule.instance().getConfig().lang.keyTemplate);
	}
