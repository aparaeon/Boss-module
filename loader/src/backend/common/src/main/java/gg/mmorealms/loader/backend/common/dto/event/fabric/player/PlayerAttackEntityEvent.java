...
@Getter
public class PlayerAttackEntityEvent extends LocalRequest<EventResult> {
	...
	public PlayerAttackEntityEvent(ServerPlayer player, Level world, InteractionHand hand, Entity entity, @Nullable EntityHitResult hitResult) {
